...
export const InfoClient = ({
  ...
  const { getClient, removeClient, clientSelected } =
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex gap-2.5 items-center justify-around w-full ">
          ...
          <ButtonSquared
            content={<FontAwesomeIcon icon={faMessage} />}
            action={() =>
              window.open(
                `https://wa.me/598${client.phone}?text=Hola!`,
                "_blank"
              )
            }
          />
